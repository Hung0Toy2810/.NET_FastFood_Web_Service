    ...
    public partial class FastfoodDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GiftPromotionID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GiftPromotionName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ProductID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GiftPromotions", x => x.GiftPromotionID);
                    table.ForeignKey(
                        name: "FK_GiftPromotions_Customers_CustomerID",
                        column: x => x.CustomerID,
                        principalTable: "Customers",
                        principalColumn: "CustomerID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GiftPromotions_Products_ProductID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GiftPromotions_CustomerID",
                table: "GiftPromotions",
                column: "CustomerID");

            migrationBuilder.CreateIndex(
                name: "IX_GiftPromotions_ProductID",
                table: "GiftPromotions",
                column: "ProductID");
